...
public abstract class NoteDatabase extends RoomDatabase {
    ...
    /**
     * Created Room Callaback and AsyncTask to add dummy notes on DB creation
     */
    ...
    private static class PopulateDbAsychTask extends AsyncTask<Void, Void, Void> {
        ...
        public PopulateDbAsychTask(NoteDatabase db) {
            noteDao = db.noteDao();
        }
        ...
        protected Void doInBackground(Void... voids) {
            ...
            noteDao.insert(new Note("TITLE1", "DESCRIPTION1", 2));
